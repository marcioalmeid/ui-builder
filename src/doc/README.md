...
## Guia para Criação e Ativação de Componentes
...
#### 1. Criar Diretório do Componente
```bash
mkdir -p src/app/components/fields-types/novo-componente
```

#### 2. Criar Arquivos do Componente
...
#### 3. Registrar o Tipo de Campo no Serviço
...
#### Verificar Componente no Preview
